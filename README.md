# Репозиторий с конспектами к докладам 
...
## IN PROGRESS
* [Андрей Беляев — DTO: живи быстро, гори ярко](./dto/DtoDieFast.md)
...
[Роман Таранов — Темная сторона Java](https://www.youtube.com/watch?v=IV46caBlmQA)
...
### Interviews
* [Александр Логинов — Матрица компетенций и оценка Java-разработчиков](https://www.youtube.com/watch?v=mqwFjVYn5o4)
